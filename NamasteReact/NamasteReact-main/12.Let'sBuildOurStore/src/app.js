...
const AppLayout = () => {
  ...
  return (
    //? Wrapping the app in Redux Store
    <Provider store={appStore}>
      {/* Using Context Provider wrapping complete app so that dynamic loggedIn */}
      {/* User is set all across. If we want to use just for Header we can just wrap
      that and not whole app. Incase of Nested wrapper, it will be updated to
